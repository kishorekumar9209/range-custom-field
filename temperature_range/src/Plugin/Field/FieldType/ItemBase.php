...
/**
 * @file
 * Contains \Drupal\temperature_range\Plugin\Field\FieldType\ItemBase.
 */

namespace Drupal\temperature_range\Plugin\Field\FieldType;
...
abstract class ItemBase extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    //$element += $this->fieldSettingsFormSubElementPrefixSuffix(t('FROM'), 'from');
    $element += $this->fieldSettingsFormSubElementPrefixSuffix(t('TO'), 'to');
  ...
  protected function fieldSettingsFormSubElementPrefixSuffix($title, $element_name) {
    ...
    /* $element[$element_name]['prefix'] = array(
      '#type' => 'textfield',
      '#title' => t('Prefix'),
    ...
    $element[$element_name]['suffix'] = array(
      '#type' => 'textarea',
      '#title' => t('Suffix select list'),
